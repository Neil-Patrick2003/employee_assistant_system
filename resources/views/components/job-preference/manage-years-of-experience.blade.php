...
>
    <div class="bg-white p-6 rounded shadow-lg w-full max-w-lg mx-auto">
        <h2 class="text-xl font-bold mb-4" x-text="'Update Years of experience'"></h2>
        ...
        >
            ...
            <!-- Form Fields -->
            <div class="mb-4">
                <input type="number" name="work_experience" x-model="formData.work_experience" class="w-full border p-2 rounded" required>
