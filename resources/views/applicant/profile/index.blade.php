        ...
        <div class="col-span-3 rounded-lg">
            <div class="grid grid-cols-3 gap-5">
                <div class="bg-white rounded p-2.5" x-data="{ modalOpen: false, formData: {{$user->job_preference}} }">
                    <x-job-preference.manage-minimum-salary
                        :show="'modalOpen'"
                        :onClose="'modalOpen = false'"
                    />

                    <x-job-preference.preference-display
                        :title="'Minimum Salary'"
                        :value="$user->job_preference->min_salary ? 'PHP '. $user->job_preference->min_salary : null "
                        :editable="$editable"
                ...
                <div class="bg-white rounded p-2.5" x-data="{ modalOpen: false, formData: {{$user->job_preference}} }">
                    <x-job-preference.manage-years-of-experience
                        :show="'modalOpen'"
                        :onClose="'modalOpen = false'"
                    />
                    ...
                    <x-job-preference.preference-display
                        ...
                        :value="$user->job_preference->work_experience"
                        :editable="$editable"
                        :action="'modalOpen = true;'"
                    />
                </div>
                ...
                <div class="bg-white rounded p-2.5" x-data="{ modalOpen: false, formData: {{$user->job_preference}} }">
                    <x-job-preference.manage-category
                        :show="'modalOpen'"
                        :onClose="'modalOpen = false'"
                    />
                    ...
                    <x-job-preference.preference-display
                        :title="'Category'"
                        :value="$user->job_preference->category"
                        :editable="$editable"
                        :action="'modalOpen = true;'"
                    />
                </div>
                <div class="bg-white rounded p-2.5" x-data="{ modalOpen: false, formData: {{$user->job_preference}} }">
                    <x-job-preference.manage-work-policy
                        :show="'modalOpen'"
                        :onClose="'modalOpen = false'"
                    />
                    ...
                    <x-job-preference.preference-display
                        :title="'Work Policy'"
                        :value="$user->job_preference->work_policy"
                        :editable="$editable"
                        :action="'modalOpen = true;'"
                    />
                </div>
                ...
                <div class="bg-white rounded p-2.5" x-data="{ modalOpen: false, formData: {{$user->job_preference}} }">
                    ...
                    <x-job-preference.preference-display
                        :title="'Scope'"
                        :value="$user->job_preference->scope"
                        :editable="$editable"
                        :action="'modalOpen = true;'"
                    />
                </div>
                ...
                <div class="bg-white rounded p-2.5" x-data="{ modalOpen: false, formData: {{$user->job_preference}} }">
                    <x-job-preference.manage-location
                        :show="'modalOpen'"
                        :onClose="'modalOpen = false'"
                    />
                    ...
                    <x-job-preference.preference-display
                        :title="'Location'"
                        :value="$user->job_preference->location"
                        :editable="$editable"
                        :action="'modalOpen = true;'"
                    />
                </div>
