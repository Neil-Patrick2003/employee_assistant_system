<x-employer-layout>
                ...
                <ol role="list" class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="#"
                                class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">{{ $job->title }}</a>
                        </div>
                    </li>
                </ol>
            </nav>
    ...
    <div
        ...
        <form action="/employer/jobs/update/    {{ $job->id }}" method="POST" id="myForm">
            @csrf
            @method('Patch')
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <select id="work_policy" name="work_policy"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm/6">
                                    <option value="{{ $job->work_policy }}">{{ $job->work_policy }}</option>
                    ...
                    <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
                        <div class="sm:col-span-2">
                            <label for="min_age" class="block text-sm/6 font-medium text-gray-900">Minimum
                                Age</label>
                            <div class="mt-2">
                                <input type="number" name="min_age" id="min-age" value="{{ $job->minimum_age }}"
                                    min="18" max="60"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
                            </div>
                            @error('min_age')
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2">
                                <input type="number" name="max_age" id="max_age" autocomplete="family-name"
                                    value="{{ $job->maximum_age }}" min="18" max="60"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
                            </div>
                            @error('max_age')
                                <div class="text-danger">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2">
                                <input type="number" name="work_experience" id="wprk_experience"
                                    value="{{ $job->requierd_work_experience }}" autocomplete="family-name"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
                            </div>
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="mt-2">
                                <select id="scope" name="scope"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm/6">
                                    >
                                    <option value="{{ $job->scope }}">{{ $job->scope }}</option>
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-2">
                                <select id="level" name="level"
                                    ...
                                    <option value="{{ $job->job_education->level }}">{{ $job->job_education->level }}
                                    </option>
                            ...
                            <div class="mt-2">
                                <textarea id="education_description" name="education_description" rows="3"
                                    class="block pl-2 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
                                        {{ old('education_description', optional($job->job_education)->description) }}
                            </textarea>
        ...
        <div class="grid grid-cols-1 gap-x-8 pt-4 gap-y-10 -b border-gray-900/10 pb-12 md:grid-cols-3">
            <div>
                <h2 class="text-base/7 font-semibold text-gray-900">Skill Requirements</h2>
            </div>
            ...
            <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
                <div class="sm:col-span-3 relative">
                    ...
                    @foreach ($job->job_skills as $skills)
                        <form action="/employer/jobs/skill/delete" method="POST">
                            @csrf
                            @method('delete')
                            <div class="mt-2 input-group" id="input-container">
                                <div class="input-item flex items-center">
