<x-landing-page-layout>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mx-auto max-w-7xl">
            <div class="flex px-12 py-4 sm: flex-col sm:flex-col md:flex-row md:flex-row">
                            ...
                            <div class="flex  gap-x-4">
                                ...
                                <div class="w-1/5 relative">
                                    ...
                                    <select name="work_policy" id="work_policy"
                                        ...
                                        <option value="Remote"
                                            {{ request('work_policy') == 'Remote' ? 'selected' : '' }}>
                                            Remote
                                        </option>
                                        <option value="Hybrid"
                                            {{ request('work_policy') == 'Hybrid' ? 'selected' : '' }}>
                                            Hybrid
                                        </option>
                                        <option value="Onsite"
                                            {{ request('work_policy') == 'Onsite' ? 'selected' : '' }}>
                                            Onsite
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="w-1/5 relative">
                                    ...
                                    <svg class="w-[22px] h-[22px] text-gray-600 absolute left-3 top-2.5"
                                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                                        height="24" fill="currentColor" viewBox="0 0 24 24">
                                        <path fill-rule="evenodd"
                                    ...
                                    <select name="category" id="category"
                                        ...
                                        <option value="Category 1"
                                            {{ request('category') == 'Category 1' ? 'selected' : '' }}>
                                            Category 1</option>
                                        <option value="Category 2"
                                            {{ request('category') == 'Category 2' ? 'selected' : '' }}>
                                            Category 2</option>
                                        <option value="Category 3"
                                            {{ request('category') == 'Category 3' ? 'selected' : '' }}>
                                            Category 3</option>
                                    </select>
                                </div>
                            </div>
